...
((SELECT person_id FROM inhabitant WHERE name = 'Aruk'), (SELECT person_id FROM inhabitant WHERE name = 'Nala'), 'food'),
((SELECT person_id FROM inhabitant WHERE name = 'Aruk'), (SELECT person_id FROM inhabitant WHERE name = 'Tara'), 'crafting'),
((SELECT person_id FROM inhabitant WHERE name = 'Aruk'), (SELECT person_id FROM inhabitant WHERE name = 'Bruk'), 'hunting'),
((SELECT person_id FROM inhabitant WHERE name = 'Aruk'), (SELECT person_id FROM inhabitant WHERE name = 'Lena'), 'hunting'),
